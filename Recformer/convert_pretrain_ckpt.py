...
PRETRAINED_CKPT_PATH = '' #your pretrained checkpoint's path e.g, result/recformer_pretraining/lightning_logs/version_x/checkpoints/xxx.ckpt
LONGFORMER_CKPT_PATH = '' #your longformer checkpoint's path e.g, longformer_ckpt/longformer-base-4096.bin
LONGFORMER_TYPE = 'longformer-base-4096'
...
state_dict = torch.load(input_file)['module']
